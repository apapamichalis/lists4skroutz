...
feature 'Sign Up', :devise do
  ...
  scenario 'visitor can sign up with valid name, email address and password' do
    sign_up_with('Jane Doe', 'test@example.com', 'please123', 'please123')
  ...
  scenario 'visitor cannot sign up with invalid email address' do
    sign_up_with('Jane', 'bogus', 'please123', 'please123')
  ...
  scenario 'visitor cannot sign up without password' do
    sign_up_with('John', 'test@example.com', '', '')
  ...
  scenario 'visitor cannot sign up with a short password' do
    sign_up_with('John Doe', 'test@example.com', 'please', 'please')
  ...
  scenario 'visitor cannot sign up without password confirmation' do
    sign_up_with('James', 'test@example.com', 'please123', '')
